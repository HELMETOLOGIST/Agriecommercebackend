# Generated by Django 5.2.7 on 2025-12-09 11:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='ecommerceapp.supplier')),
            ],
            options={
                'ordering': ('-created_at',),
            },
        ...
        migrations.AddConstraint(
            model_name='productvariant',
            constraint=models.UniqueConstraint(condition=models.Q(('weight_unit__isnull', False), ('weight_value__isnull', False)), fields=('product', 'weight_value', 'weight_unit'), name='uq_variant_product_weight'),
        ),
        migrations.AlterUniqueTogether(
            name='cartitem',
